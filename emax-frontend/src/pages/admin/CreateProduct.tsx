...
const CreateProduct = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigate after a brief delay for toast visibility
      setTimeout(() => {
        ...
        <form className="create-product-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              />
              <span className="form-hint">URL-friendly identifier. Auto-generated from name.</span>
            </div>
          </div>
          ...
          <div className="form-group form-group--full">
            ...
            <span className="form-hint">
              A high-quality image helps attract customers. Recommended: 1200x1200px.
            </span>
          </div>
